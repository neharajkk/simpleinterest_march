...
function App() {
  ...
  return (
    ...
    <div style={{backgroundColor:'white',width:'500px'}} className='p-5 mt-3 md-4 rounded'>
       ...
       <div style={{height:'150px',backgroundColor:'orange'}} className='p-3 mt-5 rounded shadow d-flex justify-content-center align-items-center'>
        ...
        <form className='mt-4' onSubmit={handleCalculate}>
          ...
          <Button variant="outlined" color="primary" style={{width:'190px' , padding:'15px'}} onClick={handleRest}>Reset</Button>
          </div>
